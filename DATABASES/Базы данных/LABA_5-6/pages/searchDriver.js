module.exports = function(app, sql){
	app.get('/driver/:idDriver', async function(req, res) {
		const { idDriver} = req.params
		const [drivers] = await sql.query(`SELECT * FROM users`)
		...
		<html>
			<body">
				<div style="max-width: 1500px; margin: 100px auto 0 auto; border: 1.5px solid black; background-color: #ede4e4; padding: 50px;">
					...
					<h1 style="font-size: 32px; text-align:center; margin-bottom: 30px;">Данные водителя № ${idDriver}</h1>
